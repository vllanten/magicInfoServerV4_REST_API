...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.MessageScheduleResource();
  });
  ...
  describe('MessageScheduleResource', function() {
    it('should create an instance of MessageScheduleResource', function() {
      ...
      //var instane = new MagicInfoApi.MessageScheduleResource();
      //expect(instance).to.be.a(MagicInfoApi.MessageScheduleResource);
    });
