...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.DeviceFilter();
  });
  ...
  describe('DeviceFilter', function() {
    it('should create an instance of DeviceFilter', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.DeviceFilter();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.DeviceFilter);
    });
