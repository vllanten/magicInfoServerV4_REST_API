...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.DeviceFilter();
  });
  ...
  describe('DeviceFilter', function() {
    it('should create an instance of DeviceFilter', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.DeviceFilter();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.DeviceFilter);
    });
