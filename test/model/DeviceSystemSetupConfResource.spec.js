...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.DeviceSystemSetupConfResource();
  });
  ...
  describe('DeviceSystemSetupConfResource', function() {
    it('should create an instance of DeviceSystemSetupConfResource', function() {
      ...
      //var instane = new MagicInfoApi.DeviceSystemSetupConfResource();
      //expect(instance).to.be.a(MagicInfoApi.DeviceSystemSetupConfResource);
    });
