...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.DeviceSystemSetupConfResource();
  });
  ...
  describe('DeviceSystemSetupConfResource', function() {
    it('should create an instance of DeviceSystemSetupConfResource', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.DeviceSystemSetupConfResource();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.DeviceSystemSetupConfResource);
    });
