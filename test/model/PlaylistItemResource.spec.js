...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.PlaylistItemResource();
  });
  ...
  describe('PlaylistItemResource', function() {
    it('should create an instance of PlaylistItemResource', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.PlaylistItemResource();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.PlaylistItemResource);
    });
