...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.DeviceDisplayCustomLogoResource();
  });
  ...
  describe('DeviceDisplayCustomLogoResource', function() {
    it('should create an instance of DeviceDisplayCustomLogoResource', function() {
      ...
      //var instane = new MagicInfoApi.DeviceDisplayCustomLogoResource();
      //expect(instance).to.be.a(MagicInfoApi.DeviceDisplayCustomLogoResource);
    });
