...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.DeviceDisplayCustomLogoResource();
  });
  ...
  describe('DeviceDisplayCustomLogoResource', function() {
    it('should create an instance of DeviceDisplayCustomLogoResource', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.DeviceDisplayCustomLogoResource();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.DeviceDisplayCustomLogoResource);
    });
