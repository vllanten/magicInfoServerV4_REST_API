...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.DeviceLedCabinetResource();
  });
  ...
  describe('DeviceLedCabinetResource', function() {
    it('should create an instance of DeviceLedCabinetResource', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.DeviceLedCabinetResource();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.DeviceLedCabinetResource);
    });
