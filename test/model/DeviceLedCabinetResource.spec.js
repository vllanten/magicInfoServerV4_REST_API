...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.DeviceLedCabinetResource();
  });
  ...
  describe('DeviceLedCabinetResource', function() {
    it('should create an instance of DeviceLedCabinetResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.DeviceLedCabinetResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.DeviceLedCabinetResource);
    });
