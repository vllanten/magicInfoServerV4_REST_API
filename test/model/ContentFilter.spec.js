...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.ContentFilter();
  });
  ...
  describe('ContentFilter', function() {
    it('should create an instance of ContentFilter', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.ContentFilter();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.ContentFilter);
    });
