...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.ContentFilter();
  });
  ...
  describe('ContentFilter', function() {
    it('should create an instance of ContentFilter', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.ContentFilter();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.ContentFilter);
    });
