...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.DeviceDisplayConfSubResource();
  });
  ...
  describe('DeviceDisplayConfSubResource', function() {
    it('should create an instance of DeviceDisplayConfSubResource', function() {
      ...
      //var instane = new MagicInfoApi.DeviceDisplayConfSubResource();
      //expect(instance).to.be.a(MagicInfoApi.DeviceDisplayConfSubResource);
    });
