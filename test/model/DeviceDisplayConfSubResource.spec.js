...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.DeviceDisplayConfSubResource();
  });
  ...
  describe('DeviceDisplayConfSubResource', function() {
    it('should create an instance of DeviceDisplayConfSubResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.DeviceDisplayConfSubResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.DeviceDisplayConfSubResource);
    });
