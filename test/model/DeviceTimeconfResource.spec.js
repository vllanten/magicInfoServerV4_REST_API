...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.DeviceTimeconfResource();
  });
  ...
  describe('DeviceTimeconfResource', function() {
    it('should create an instance of DeviceTimeconfResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.DeviceTimeconfResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.DeviceTimeconfResource);
    });
