...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.DeviceTimeconfResource();
  });
  ...
  describe('DeviceTimeconfResource', function() {
    it('should create an instance of DeviceTimeconfResource', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.DeviceTimeconfResource();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.DeviceTimeconfResource);
    });
