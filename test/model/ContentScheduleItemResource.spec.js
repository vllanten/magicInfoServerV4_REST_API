...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.ContentScheduleItemResource();
  });
  ...
  describe('ContentScheduleItemResource', function() {
    it('should create an instance of ContentScheduleItemResource', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.ContentScheduleItemResource();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.ContentScheduleItemResource);
    });
