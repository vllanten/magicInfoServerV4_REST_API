...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.ContentScheduleItemResource();
  });
  ...
  describe('ContentScheduleItemResource', function() {
    it('should create an instance of ContentScheduleItemResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.ContentScheduleItemResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.ContentScheduleItemResource);
    });
