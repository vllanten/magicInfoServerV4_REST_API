...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.ScheduleFilter();
  });
  ...
  describe('ScheduleFilter', function() {
    it('should create an instance of ScheduleFilter', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.ScheduleFilter();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.ScheduleFilter);
    });
