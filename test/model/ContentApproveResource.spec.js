...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.ContentApproveResource();
  });
  ...
  describe('ContentApproveResource', function() {
    it('should create an instance of ContentApproveResource', function() {
      ...
      //var instane = new MagicInfoApi.ContentApproveResource();
      //expect(instance).to.be.a(MagicInfoApi.ContentApproveResource);
    });
