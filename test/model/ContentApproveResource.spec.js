...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.ContentApproveResource();
  });
  ...
  describe('ContentApproveResource', function() {
    it('should create an instance of ContentApproveResource', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.ContentApproveResource();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.ContentApproveResource);
    });
