...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4RestApi.PlaylistResource();
  });
  ...
  describe('PlaylistResource', function() {
    it('should create an instance of PlaylistResource', function() {
      ...
      //var instane = new MagicInfoServerV4RestApi.PlaylistResource();
      //expect(instance).to.be.a(MagicInfoServerV4RestApi.PlaylistResource);
    });
