...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.ContentScheduleResource();
  });
  ...
  describe('ContentScheduleResource', function() {
    it('should create an instance of ContentScheduleResource', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.ContentScheduleResource();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.ContentScheduleResource);
    });
