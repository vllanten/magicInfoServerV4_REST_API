...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.ContentScheduleResource();
  });
  ...
  describe('ContentScheduleResource', function() {
    it('should create an instance of ContentScheduleResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.ContentScheduleResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.ContentScheduleResource);
    });
