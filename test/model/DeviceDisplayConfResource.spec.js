...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.DeviceDisplayConfResource();
  });
  ...
  describe('DeviceDisplayConfResource', function() {
    it('should create an instance of DeviceDisplayConfResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.DeviceDisplayConfResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.DeviceDisplayConfResource);
    });
