...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoApi.DeviceDisplayConfResource();
  });
  ...
  describe('DeviceDisplayConfResource', function() {
    it('should create an instance of DeviceDisplayConfResource', function() {
      ...
      //var instane = new MagicInfoApi.DeviceDisplayConfResource();
      //expect(instance).to.be.a(MagicInfoApi.DeviceDisplayConfResource);
    });
