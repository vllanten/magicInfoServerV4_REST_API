...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.UserFilter();
  });
  ...
  describe('UserFilter', function() {
    it('should create an instance of UserFilter', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.UserFilter();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.UserFilter);
    });
