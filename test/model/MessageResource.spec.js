...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV4xRestApi.MessageResource();
  });
  ...
  describe('MessageResource', function() {
    it('should create an instance of MessageResource', function() {
      ...
      //var instane = new MagicInfoServerV4xRestApi.MessageResource();
      //expect(instance).to.be.a(MagicInfoServerV4xRestApi.MessageResource);
    });
