...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.HashMapstringobject();
  });
  ...
  describe('HashMapstringobject', function() {
    it('should create an instance of HashMapstringobject', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.HashMapstringobject();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.HashMapstringobject);
    });
