...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.Response();
  });
  ...
  describe('Response', function() {
    it('should create an instance of Response', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.Response();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.Response);
    });
