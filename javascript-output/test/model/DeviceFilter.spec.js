...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.DeviceFilter();
  });
  ...
  describe('DeviceFilter', function() {
    it('should create an instance of DeviceFilter', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.DeviceFilter();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.DeviceFilter);
    });
