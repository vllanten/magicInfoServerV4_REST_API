...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MagicInfoServerV41RestApi.TagResource();
  });
  ...
  describe('TagResource', function() {
    it('should create an instance of TagResource', function() {
      ...
      //var instane = new MagicInfoServerV41RestApi.TagResource();
      //expect(instance).to.be.a(MagicInfoServerV41RestApi.TagResource);
    });
