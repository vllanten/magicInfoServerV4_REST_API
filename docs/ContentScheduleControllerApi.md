# MagicInfoServerV4xRestApi.ContentScheduleControllerApi
...
var apiInstance = new MagicInfoServerV4xRestApi.ContentScheduleControllerApi();

var programId = "programId_example"; // String | programId

var params = new MagicInfoServerV4xRestApi.ContentScheduleResource(); // ContentScheduleResource | params
...
var filter = new MagicInfoServerV4xRestApi.ScheduleFilter(); // ScheduleFilter | filter
