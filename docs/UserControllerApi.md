# MagicInfoServerV41RestApi.UserControllerApi
...
var apiInstance = new MagicInfoServerV41RestApi.UserControllerApi();

var filter = new MagicInfoServerV41RestApi.UserFilter(); // UserFilter | filter
