# MagicInfoServerV41RestApi.PlaylistControllerApi
...
var apiInstance = new MagicInfoServerV41RestApi.PlaylistControllerApi();

var playlistId = "playlistId_example"; // String | playlistId

var params = new MagicInfoServerV41RestApi.PlaylistResource(); // PlaylistResource | params
...
var filter = new MagicInfoServerV41RestApi.PlaylistFilter(); // PlaylistFilter | filter
